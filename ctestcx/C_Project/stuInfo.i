...
void save();
void load();
void showStudentInfo(STUDENT students[]);
# 10 "stuInfo.c" 2
...
# 1 "/Applications/Xcode-Beta.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/../lib/clang/6.0/include/stdint.h" 1 3 4
# 64 "/Applications/Xcode-Beta.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/../lib/clang/6.0/include/stdint.h" 3 4
...
# 65 "/Applications/Xcode-Beta.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/../lib/clang/6.0/include/stdint.h" 2 3 4
...
void save()
{
    ...
    puts("文件打开成功！");
    if (fp!=((void *)0)) {
        fprintf(fp, "%s\n","num\tname\tage\tMath\tPhysics\tEnglish\tComputer\tTotalGrade");
        for (int i = 0; i<5; ++i) {
...
void load()
{
    ...
    if (fp!=((void *)0)) {
        ...
        for (int i = 0; i<5; i++) {
            ...
            fscanf(fp, "%f",&students[i].TotalGrade);
        }
        for (int i = 0; i<5; ++i) {
